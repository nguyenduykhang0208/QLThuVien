namespace ThuVien.Migrations
{
    ...
    public partial class create_DB : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        trangthaitra = c.Boolean(nullable: false),
                        tuchoi = c.Boolean(nullable: false),
                        lydotuchoi = c.String(maxLength: 2000),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.phieumuon", "userID", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.phieumuon", new[] { "userID" });
